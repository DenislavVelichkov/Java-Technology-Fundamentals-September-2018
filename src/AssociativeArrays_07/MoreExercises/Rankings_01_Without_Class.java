...
public class Rankings_01_Without_Class {
    ...
    public static void main(String[] args) {
        ...
        String contestAndPassword = sc.nextLine();
        ...
        while (!contestAndPassword.equals("end of contests")) {
            ...
            contestAndPassword = sc.nextLine();
        }
        ...
        while (!submissions.equals("end of submissions")) {
            ...
            if ((contestContainer.containsKey(tokens[0])) &&
                ...
                if (userDB.get(tokens[2]).get(tokens[0]) < Integer.parseInt(tokens[3])) {
                    userDB.get(tokens[2]).put(tokens[0], Integer.parseInt(tokens[3]));
                }
        ...
        userDB.entrySet().stream().sorted(Map.Entry.comparingByKey())
                .forEach(entry -> {
                    ...
                    entry.getValue().entrySet().stream().sorted((o1, o2) -> {
