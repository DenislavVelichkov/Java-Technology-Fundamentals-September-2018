package Exam_Exercises.ProgFundRetakeExam_27October2018Part2;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < firstPart.length(); i++) {
            ...
            if (symbol == '#' ||
                    ...
                    symbol == '*' ||
                    symbol == '&') {
                //намира символа на посочения индекс
                int index = firstPart.indexOf(symbol, i + 1);
                // Overload на невалидния индекс (-1) когато няма такъв символ да започва от 0 отново, за да не чупи цикъла.
                if (index != -1) {
