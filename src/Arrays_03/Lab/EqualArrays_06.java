        ...
        for (int i = 0; i < maxLength; i++) {
            sum += array1[i];
                if (array1[i] != array2[i]) {
                    System.out.printf("Arrays are not identical. Found difference at %TopInteger_05_Ver2 index.", i);
                    return;
            }
        }
        System.out.printf("Arrays are identical. Sum: %TopInteger_05_Ver2", sum);
    }
}
