        ...
        while (true) {
            ...
            switch (action) {
                ...
                case "max":
                    ...
                    if (index == -1) {
                        System.out.println(("No matches"));     //if a min/max even/odd element cannot be found
                    } else {                                    //The split index will be an integer in the range [-2^31 … 2^31 – 1]

                        System.out.println((index));
                    }
                    break;
                case "min":
                    int minIndex = GetMinIndex(tokens, numbers);        //if a min/max even/odd element cannot be found
                    if (minIndex == -1) {
